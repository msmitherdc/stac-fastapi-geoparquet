...
def test_freetext_multi_term_and_semantics(client: TestClient) -> None:
    # "naip" appears in the id/description only for naip collections.
    data = _get_collections(client, q="rustac 10000")
